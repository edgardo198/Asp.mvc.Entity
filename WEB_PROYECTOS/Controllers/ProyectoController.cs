...
namespace WEB_PROYECTOS.Controllers
{
    ...
    public class ProyectoController : Controller
    {
        ...
        {
            var proyectos = ProyectoCN.ListarProyecto();
        ...
        {
            return View(ProyectoCN.ListasAsignaciones());
        }
        ...
        public ActionResult DescargarReporteProyectos()
        {
            try
            {
                ...
                rptH.FileName = Server.MapPath("/Reportes/ProyectoListas.rpt");
                rptH.Load();
        ...
        public ActionResult DescargarReporteAsignaciones(int? id)
        {
            try
            {
                //var asignaciones = ProyectoCN.ListasAsignaciones();

                var rptH = new ReportClass();
                rptH.FileName = Server.MapPath("/Reportes/AsignacionReport1.rpt");
                rptH.Load();

                if (id == null)
                    rptH.SetDataSource(ProyectoCN.ListasAsignaciones());
                else
                    rptH.SetDataSource(ProyectoCN.ListasAsignaciones(id.Value));
